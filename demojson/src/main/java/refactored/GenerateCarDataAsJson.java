...
public class GenerateCarDataAsJson {
	...
	static List<String> doorsList = new ArrayList<> (Arrays.asList("3","4","5")) ;
...
//		System.out.println(locations);
		...
		for (int i = 0; i < 500; i++) {
			...
			doors = getRandomValueFromSet(doorsList);
			engine = getRandomValueFromSet(engines) ;
			newLine.append("{\n");
			newLine.append("\t\"registration\":\"");
